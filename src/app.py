...
if __name__ == "__main__":
    ...
    # Aplicação da fonte customizada
    ...
    # ==========================================
    with st.sidebar:
        st.image(obter_caminho_imagem("DataDiscovery.png"), use_container_width=True)
        st.markdown("---")
        
        # O botão radio cria a lista de navegação
        pagina_selecionada = st.radio(
            ...
            [
                ...
                "01 - Implementação",
                "02 - Considerações",
                "03 - Tipos de Ferramentas",
                "04 - Métodos de Busca",
                "05 - Microsoft Presidio",
                "06 - Tratamento de Dados",
                "07 - Casos de Aplicação"
            ]
        )
        st.markdown("---")
        st.write("Projeto Educacional - LGPD")
    ...
    with coluna_central:
        with st.container(border=False, horizontal_alignment="center"):
            ...
            # --- Página 00 ---
            if pagina_selecionada == "00 - Início":
                st.image(obter_caminho_imagem("DataDiscovery.png"), caption="Bem-vindo ao projeto sobre Data Discovery e Anonimização.")

            # --- Página 01 ---
            elif pagina_selecionada == "01 - Implementação":
            ...
            # --- Página 02 ---
            elif pagina_selecionada == "02 - Considerações":
            ...
            # --- Página 03 ---
            elif pagina_selecionada == "03 - Tipos de Ferramentas":
            ...
            # --- Página 04 ---
            elif pagina_selecionada == "04 - Métodos de Busca":
            ...
            # --- Página 05 ---
            elif pagina_selecionada == "05 - Microsoft Presidio":
            ...
            # --- Página 06 ---
            elif pagina_selecionada == "06 - Tratamento de Dados":
            ...
            # --- Página 07 ---
            elif pagina_selecionada == "07 - Casos de Aplicação":
